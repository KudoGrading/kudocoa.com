import{createLogger}from"../../../shared/lib/log.min.js";function trackMouseZoom(n,{scale:i=1.5}={}){var t=createLogger({prefix:"trackMouseZoom()",debugMode:location.search.includes("debug")});if(!n.parentElement)return t.error("img.parentElement not found!");if(!n.parentElement.classList.contains("zoom-container")){t.debug("Creating zoom container...");let e=document.createElement("div");e.className="zoom-container",n.style.cssText=`
